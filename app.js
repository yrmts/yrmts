var main = function(){
  ...
  $('ul li:nth-child(2)').click(function(){
    ...
    $('.description').delay(300).show('drop', {direction: 'down'}, 500);
    $('#profile-title').delay(1200).show('drop', {direction: 'down'}, 500);
    $('#profile-img').delay(600).show('drop', {direction: 'down'}, 500);
  });
